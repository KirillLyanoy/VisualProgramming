        ...
        public sealed override void Render(DrawingContext context)
        {
            ...
            switch (Standart)
            {
                ...
                case (Standart.ANSI):
                    ...
                    context.DrawLine(new Pen(Brushes.Black, 2, null, PenLineCap.Flat, PenLineJoin.Miter, 10), point_1, point_2);
                    context.DrawLine(new Pen(Brushes.Black, 2, null, PenLineCap.Flat, PenLineJoin.Miter, 10), point_1, point_3);
                    context.DrawLine(new Pen(Brushes.Black, 2, null, PenLineCap.Flat, PenLineJoin.Miter, 10), point_2, point_4);

                    context.DrawLine(new Pen(Brushes.Black, 2, null, PenLineCap.Flat, PenLineJoin.Miter, 10), new Point(startPoint.X - 50, startPoint.Y + 25), new Point(startPoint.X, startPoint.Y + 25));
                    context.DrawLine(new Pen(Brushes.Black, 2, null, PenLineCap.Flat, PenLineJoin.Miter, 10), new Point(startPoint.X - 50, startPoint.Y + 75), new Point(startPoint.X, startPoint.Y + 75));
                    context.DrawLine(new Pen(Brushes.Black, 2, null, PenLineCap.Flat, PenLineJoin.Miter, 10), new Point(startPoint.X + 80, startPoint.Y + 50), new Point(startPoint.X + 100, startPoint.Y + 50));

                    context.DrawEllipse(Brushes.White, new Pen(Brushes.Black, 2, null, PenLineCap.Flat, PenLineJoin.Miter, 10), new Rect(new Point(startPoint.X + 80, startPoint.Y + 46), new Size(8, 8)));
