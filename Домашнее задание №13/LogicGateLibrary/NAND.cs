    ...
    public class NAND : LogicGate
    {
        ...
        public sealed override void Render(DrawingContext context)
        {
            ...
            switch (Standart)
            {
                ...
                case (Standart.ANSI):
                    if (IsSelected)
                        context.DrawRectangle(Brushes.Transparent, new Pen(Brushes.Black, 2, DashStyle.DashDotDot, PenLineCap.Flat, PenLineJoin.Miter, 10), new Rect(new Point(StartPoint.X - 10, StartPoint.Y), new Size(108, 100)));
